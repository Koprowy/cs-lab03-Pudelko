...
[X]3. Zaimplementuj _properties_ o nazwach `A`, `B` i `C` zwracające wymiary pudełka w metrach (z dokładnością do 3 miejsc po przecinku).

[X]4. Reprezentacja tekstowa, `ToString`
 ...
 [X] 5. Zaimplementuj _property_ `Objetosc` zwracające objętość pudełka w m³. Wynik zaokrąglij (`Math.Round`) do 9. miejsc po przecinku.

 [X]6. Zaimplementuj _property_ `Pole` zwracające pole powierzchni całkowitej pudełka (prostopadłościanu) w m². Wynik zaokrąglij (`Math.Round`) do 6. miejsc po przecinku.
 ...
 [X]10. Przeglądanie długości krawędzi - indexer
 ...
 [X]11. Przeglądanie długości krawędzi - pętla `foreach`
 ...
 [X]12. Metoda parsująca ze `string`
 ...
 [X]13. Pamiętaj o zapewnieniu pełnej niezmienniczości obiektom klasy `Pudelko` oraz o zapieczętowaniu klasy.

 [X]14. Utwórz testy jednostkowe (_unit tests_) dla:
